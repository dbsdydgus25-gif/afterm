                    ...
                    <div className="space-y-3">
                        ...
                        >
                            <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                                <path d="M12 3C5.373 3 0 7.378 0 12.78c0 3.326 2.067 6.256 5.289 8.075-.246.907-.89 3.292-.916 3.486 0 0-.017.158.082.217.098.058.21.033.21.033.272-.038 3.093-2.105 3.567-2.428.625 0 24-.268 24-.268l-3.35 1.765-.41.217c.504.148 1.026.223 1.558.223 6.627 0 12-4.378 12-9.78C24 7.378 18.627 3 12 3z" />
                            </svg>
                            카카오로 시작하기
                        </Button>
