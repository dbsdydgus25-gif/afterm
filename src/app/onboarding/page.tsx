    ...
    <div style={{ display: 'flex', gap: 6, marginBottom: 32 }}>
      {Array.from({ length: total }).map((_, i) => (
        <div key={i} style={{
          ...
          background: i < current ? '#2563EB' : '#e8eaed',
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            ...
            <button
              ...
              style={{
                ...
                background: '#2563EB', fontSize: 15, fontWeight: 700, color: '#fff', cursor: 'pointer',
              }}
            >
              네, 맞습니다
            </button>
    ...
    <div>
      ...
      <div style={{ position: 'relative', marginBottom: 16 }}>
        <input
          ...
          disabled={verified}
          style={{ ...inputStyle, borderColor: verified ? '#2563EB' : '#e0e0e0', paddingRight: 90 }}
        />
        <button
          onClick={sendOtp}
      ...
      <button
        ...
        style={{
          ...
          background: verified ? '#2563EB' : '#e0e0e0',
    ...
    <div>
      ...
      <div style={{ marginBottom: 20 }}>
        <input
          ...
          style={{ ...inputStyle, borderColor: focus === 'pw' ? '#2563EB' : '#e0e0e0' }}
        />
      </div>
      ...
      <div style={{ marginBottom: 8 }}>
        <input
          ...
          onBlur={() => setFocus(null)}
          style={{ ...inputStyle, borderColor: focus === 'pw2' ? '#2563EB' : match ? '#22c55e' : '#e0e0e0' }}
        />
        {pw2.length > 0 && (
      ...
      <button
        ...
        style={{
          position: 'fixed', bottom: 0, left: '50%', transform: 'translateX(-50%)',
          width: '100%', maxWidth: 480, padding: '18px 24px',
          background: valid && match ? '#2563EB' : '#e0e0e0',
