...
export async function notifySenderOfView(messageId: string) {
    ...
    try {
        ...
        const mailOptions = {
            ...
            to: senderEmail,
            subject: `[AFTERM] 수신인이 메시지 열람을 시도하고 있습니다`,
            html: `
                <div style="font-family: 'Helvetica Neue', Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333; line-height: 1.6;">
                    ...
                    <div style="padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 10px 10px;">
                        <h2 style="color: #111; margin-top: 0;">⚠️ 메시지 열람 시도 알림</h2>
                        <p style="font-size: 16px;">
                            안녕하세요, <strong>${senderName}</strong>님.
                        </p>
                        <p>
                            수신인이 회원님의 메시지(ID: <span style="font-family: monospace; background: #f3f4f6; padding: 2px 4px; border-radius: 4px;">${messageId.slice(0, 8)}...</span>)의 열람을 시도하고 있습니다.
                        </p>
                        
                        <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 15px; margin: 20px 0;">
                            <p style="margin: 0; color: #92400e; font-weight: bold;">
                                ✓ 수신인이 "확인" 버튼을 눌렀기 때문에 이 메일이 발송되었습니다.<br/>
                                ✓ 회원님께 문제가 없으시다면, 서비스에 접속하여 상태를 업데이트해주세요.
                            </p>
                        </div>
                        ...
                        <p style="font-size: 14px; color: #6b7280; margin-top: 30px;">
                            * 이 알림은 수신인이 메시지 열람을 확인했을 때 발송됩니다.<br/>
