...
export async function POST(request: Request) {
    try {
        ...
        if ((currentPlan === 'free' && targetPlan === 'pro') ||
            ...
            // SPECIAL PROMOTION: 3 Months Free Trial Logic (Instead of standard)
            // If it's a new upgrade (Free -> Pro), give 3 months (90 days).
            // If it's a switch (Month <-> Year), stick to standard logic? 
            // User asked for "3 Months Pro Trial Free". Let's apply it to ALL upgrades for now.

            // Actually, keep standard structure but modify date calc.
            ...
            return NextResponse.json({
                ...
                plan: 'pro',
                billingCycle,
                message: '3개월 무료 체험이 시작되었습니다! (90일간 무제한 이용)' // Upldated message
            });
        }
