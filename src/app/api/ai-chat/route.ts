...
- 카테고리는 반드시 아래 5가지 중 하나만 사용하세요 (다른 값 절대 사용 금지):
  ① 통신 — SKT, KT, LGU+ 등 통신/인터넷 요금
  ② 유료구독 — Netflix, 티빙, 멜론, Adobe 등 정기결제 서비스 (무료는 절대 불가)
  ③ 클라우드 — iCloud, 구글드라이브, 네이버 MYBOX 등 저장 서비스
  ④ SNS — Instagram, Facebook, Twitter/X, TikTok 등 소셜 계정
  ⑤ 기타 — 위 4가지에 속하지 않거나, 무료로 가입된 무과금 계정들
- [LEGACY_LIST] 반환 형식:
  {"items": [{"id": "1", "service": "서비스명", "cost": "월 N원 또는 무료", "date": "갱신일 또는 기록 없음", "category": "통신 또는 유료구독 또는 클라우드 또는 SNS 또는 기타"}]}
