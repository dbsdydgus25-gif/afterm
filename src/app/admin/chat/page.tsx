    ...
    <div style={{ fontFamily: "'Pretendard Variable', Pretendard, sans-serif", height: 'calc(100vh - 40px)', display: 'flex', gap: 20 }}>
            ...
            >
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 4 }}>
                <span style={{
                  ...
                  color: selectedUserId === t.userId ? '#2563EB' : '#111827',
                }}>
                  {displayName(t)}
                </span>
      ...
      <div style={{
        ...
        {!selectedThread ? (
          ...
          <>
            {/* 헤더 */}
            <div style={{ padding: '14px 20px', background: '#2563EB', display: 'flex', alignItems: 'center', gap: 12 }}>
              <div style={{
            ...
            <div style={{ padding: '12px 16px', background: '#fff', borderTop: '1px solid #E8EAF0', display: 'flex', gap: 10 }}>
              ...
              <button
                ...
                style={{
                  ...
                  background: reply.trim() ? '#2563EB' : '#E5E7EB',
