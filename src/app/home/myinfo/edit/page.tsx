...
export default function EditProfilePage() {
  ...
  if (loading) return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#F4F6F9' }}>
      <div style={{ width: 28, height: 28, border: '3px solid #E5E7EB', borderTopColor: '#163272', borderRadius: '50%', animation: 'spin 0.7s linear infinite' }} />
  ...
  return (
    <div style={{ fontFamily: "'Pretendard Variable', Pretendard, sans-serif", maxWidth: 480, margin: '0 auto', minHeight: '100vh', background: '#F4F6F9' }}>
      <style>{`
        ...
        input:focus{border-color:#163272!important;box-shadow:0 0 0 3px rgba(22,50,114,0.08)!important;outline:none!important}
      `}</style>
            ...
            <Row
              ...
              badge={phone ? (
                <div style={{ display: 'flex', alignItems: 'center', gap: 4, background: '#EBF3FF', padding: '3px 8px', borderRadius: 99 }}>
                  <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="#163272" strokeWidth="3"><polyline points="20 6 9 17 4 12"/></svg>
      ...
      {section === 'name' && (
        <div style={{ padding: '32px 20px' }}>
          ...
          <button onClick={saveName} disabled={saving || !nameInput.trim()} style={{
            ...
            background: nameInput.trim() ? '#163272' : '#E5E7EB',
          ...
          {phone && !otpVerified && (
            <div style={{ background: '#F9FAFB', borderRadius: 12, padding: '14px 18px', marginBottom: 24, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 5, background: '#EBF3FF', padding: '5px 10px', borderRadius: 99 }}>
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#163272" strokeWidth="3"><polyline points="20 6 9 17 4 12"/></svg>
                <span style={{ fontSize: 11, fontWeight: 700, color: '#163272' }}>인증완료</span>
              </div>
            </div>
          )}
