    ...
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', padding: '24px 24px 40px' }}>
      ...
      <div style={{ background: '#fff', borderRadius: 14, border: '1px solid #E5E7EB', padding: '18px 20px', marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between' }}>
          ...
          <span style={{ fontSize: 20, fontWeight: 900, color: '#163272', letterSpacing: '-0.02em' }}>{grandTotal.toLocaleString()}원</span>
        </div>
      </div>
        ...
        {methods.map((m) => (
          <button
            ...
            style={{
              ...
              border: payMethod === m.id ? '2px solid #163272' : '1.5px solid #E5E7EB',
          ...
          >
            ...
            <span style={{ fontSize: 13, fontWeight: 800, color: payMethod === m.id ? '#163272' : '#374151' }}>{m.label}</span>
      ...
      <button
        ...
        style={{
          ...
          background: loading ? '#9CA3AF' : payMethod === 'EASY_PAY' ? '#FEE500' : '#163272',
