      ...
      <main className="flex-1 w-full max-w-4xl mx-auto px-6 py-32 md:py-40">
        <section className="space-y-12">
          ...
          <div className="space-y-6">
            <span className="inline-block py-1 px-3 rounded-full bg-slate-100 text-slate-600 text-[10px] md:text-xs font-bold tracking-wide">
              OUR MISSION
            </span>
            ...
            <p className="text-sm md:text-lg text-slate-600 leading-relaxed max-w-2xl break-keep">
              우리는 누구나 언젠가는 떠난다는 사실을 알고 있습니다.<br className="hidden md:block" />
              하지만 소중한 사람들에게 남기고 싶은 마지막 인사는 늘 준비되지 않은 상태로 찾아옵니다.<br className="block md:hidden" /><br className="hidden md:block" />
