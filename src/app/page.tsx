  ...
  return (
    <>
      ...
      <div style={{
        ...
        ════════════════════════════════ */}
        <div style={{
          background: 'linear-gradient(155deg,#0b1d47 0%,#2563EB 55%,#1c4494 100%)',
          paddingBottom: 64,
          position: 'relative',
          overflow: 'hidden',
        }}>
        ...
        <section style={{ padding:'0 24px 72px', textAlign:'center' }}>
          <Fade>
            ...
            <h2 style={{ fontSize:26, fontWeight:800, color:'#111', margin:'0 0 12px', lineHeight:1.45, wordBreak:'keep-all' }}>
              에프텀이 고인의<br />
              <span style={{ color:'#2563EB' }}>장례 그 이후</span>를<br />
              함께 하겠습니다
            </h2>
        ...
        <section style={{ padding:'0 24px 72px', background:'#f7f9ff', marginBottom:0 }}>
          <div style={{ paddingTop:56 }}>
              ...
              <Fade key={step.num} delay={i * 70}>
                <div style={{ display:'flex', gap:16, marginBottom:20, alignItems:'flex-start' }}>
                  <div style={{
                    ...
                    <span style={{ fontSize:12, fontWeight:800, color:'#2563EB' }}>{step.num}</span>
                  </div>
            ...
            <Fade delay={300}>
              <div style={{ marginTop:8, padding:'18px 20px', background:'#edf3ff', borderRadius:14, borderLeft:'4px solid #2563EB' }}>
                <p style={{ color:'#2563EB', fontSize:14, margin:0, lineHeight:1.75, fontWeight:700, wordBreak:'keep-all' }}>
                  남겨진 포인트·혜택은<br />
        ...
        <section style={{ padding:'0 0 80px' }}>
          <Fade>
            <div style={{ padding:'0 24px', marginBottom:32 }}>
              <p style={{ fontSize:12, fontWeight:700, color:'#2563EB', letterSpacing:'0.12em', textTransform:'uppercase', margin:'0 0 10px' }}>Price Comparison</p>
                  ...
                  <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
                    <div style={{ display:'flex', alignItems:'center', gap:14 }}>
                      <div style={{ width:36, height:36, borderRadius:10, background:'#EFF6FF', display:'flex', alignItems:'center', justifyContent:'center', flexShrink:0 }}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z" stroke="#2563EB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>
                      </div>
                      <div>
        ...
        <section style={{ padding:'0 24px 56px' }}>
          <Fade>
            <div style={{
              background:'linear-gradient(135deg,#0b1d47,#2563EB)',
